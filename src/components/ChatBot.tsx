...
const ChatBot: React.FC<ChatBotProps> = ({ isDarkTheme }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[9999] flex flex-col items-end pointer-events-none">
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ref={chatWindowRef}
            ...
            className={`w-[calc(100vw-48px)] sm:w-[420px] h-[600px] max-h-[calc(100vh-140px)] border rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden mb-6 backdrop-blur-3xl pointer-events-auto ${
